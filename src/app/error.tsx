  ...
  return (
    <div className="relative flex h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-xl flex-col items-center justify-center px-6 text-center">
        ...
        >
          <div className="absolute inset-0 scale-125 bg-gradient-to-r from-red-500/30 via-orange-500/30 to-red-600/30 blur-[60px]" />

          <h1 className="relative text-6xl leading-none font-black tracking-tight md:text-7xl">
            <span className="bg-gradient-to-b from-white via-red-50 to-red-200 bg-clip-text text-transparent drop-shadow-2xl">
              Oops!
            </span>
          </h1>
        </div>
