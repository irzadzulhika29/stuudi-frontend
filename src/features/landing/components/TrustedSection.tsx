...
const testimonials = [
  {
    quote:
      "Stuudi sangat membantu kami dalam menyelenggarakan ujian berbasis komputer. Pengelolaan soal hingga penilaian menjadi lebih efisien.",
    name: "Andi Pratama",
    role: "Admin Akademik",
  },
  {
  ...
  {
    quote:
      "Antarmuka Stuudi mudah dipahami oleh dosen maupun mahasiswa. Sistemnya stabil dan mendukung pelaksanaan CBT dengan baik.",
    name: "Budi Santoso",
    role: "Dosen",
  },
  {
