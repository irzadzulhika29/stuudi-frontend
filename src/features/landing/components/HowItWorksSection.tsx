    ...
    icon: (
      ...
      >
        ...
        <rect
          ...
          opacity="0.1"
        />
        <rect x="26" y="4" width="10" height="8" rx="2" fill="#cf2e2e" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {steps.map((step, index) => (
          ...
          >
            ...
            <div className="relative text-primary mb-4">{step.icon}</div>
