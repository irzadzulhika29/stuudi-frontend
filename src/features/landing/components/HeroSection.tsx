...
export default function HeroSection() {
  return (
    <section className="px-4 relative min-h-screen overflow-hidden bg-[url('/images/hero-bg.svg')] bg-cover bg-center bg-no-repeat">
      <div className="max-w-6xl mx-auto relative pt-32 pb-16 lg:pt-40 lg:pb-24">
