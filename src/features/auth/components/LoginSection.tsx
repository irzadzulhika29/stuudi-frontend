    ...
    <HeroWrapper>
      <div className=" max-w-4xl mx-auto flex justify-between gap-12 items-center">
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          ...
          <h1 className=" text-2xl text-center font-bold text-primary-dark mb-8 leading-tight">
          ...
          <form className="space-y-5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-5 py-3 rounded-xl bg-white border border-transparent focus:border-[#27A8F3] focus:ring-2 focus:ring-[#27A8F3]/20 focus:outline-none transition-all shadow-sm placeholder:text-gray-400 text-gray-800"
              />
            </div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-5 py-3 rounded-xl bg-white border border-transparent focus:border-[#27A8F3] focus:ring-2 focus:ring-[#27A8F3]/20 focus:outline-none transition-all shadow-sm placeholder:text-gray-400 text-gray-800 pr-12"
              />
              <button
                type="button"
        ...
        <div className="hidden lg:block relative h-[500px] w-[300px]">
          ...
          <div className="absolute -top-8 -right-8 drop-shadow-2xl transform rotate-12">
           <Image width={100} height={100} src="/images/auth/shield.svg" alt=""/>
          </div>
        </div>
      </div>
    </HeroWrapper>
