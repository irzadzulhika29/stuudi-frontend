...
const contactInfo = [
  {
    ...
    label: "arteri.official@gmail.com",
    href: "mailto:arteri.official@gmail.com",
  },
  {
    icon: (
      <svg
...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://instagram.com/arteri",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/arteri",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/60 text-sm">
            © {new Date().getFullYear()} Arteri. Hak Cipta Dilindungi.
          </p>
